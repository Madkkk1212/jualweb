      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-black text-foreground uppercase tracking-widest">{tr.servicesHeading}</h4>
            <ul className="space-y-4">
              {[
                ...
                { label: tr.contactHeading.replace(" Kami", "").replace(" Us", ""), href: "/contact" },
              ].map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-foreground/50 hover:text-accent-blue transition-colors font-medium">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-6">
            <h4 className="text-sm font-black text-foreground uppercase tracking-widest">{tr.contactHeading}</h4>
            <ul className="space-y-4">
              <li>
                <Link href={whatsappUrl} target="_blank" className="text-foreground/50 hover:text-accent-green transition-colors font-medium">
                  WhatsApp: 0895-1461-8737
                </Link>
              </li>
              <li>
                <Link href={instagramUrl} target="_blank" className="text-foreground/50 hover:text-accent-blue transition-colors font-medium">
                  Instagram: @lumaspace.web.id
                </Link>
              </li>
              <li>
                <Link href="mailto:lumaspace@gmail.com" className="text-foreground/50 hover:text-accent-blue transition-colors font-medium">
                  Email: lumaspace@gmail.com
                </Link>
              </li>
              <li className="text-foreground/50 font-medium">{tr.location}</li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-10 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-sm text-foreground/30 font-bold uppercase tracking-widest">
            &copy; {new Date().getFullYear()} LumaSpace. {tr.copyright}
          </div>
          <div className="flex gap-8 text-xs font-bold text-foreground/40 uppercase tracking-widest">
            <Link href="#" className="hover:text-foreground">{tr.privacy}</Link>
            <Link href="#" className="hover:text-foreground">{tr.terms}</Link>
          </div>
        </div>
      </div>
    </footer>
